...
/// </summary>
//! [bracket]
void OrderSamples::BracketOrder(int parentOrderId, Order &parent, Order &takeProfit, Order &stopLoss, std::string action, double quantity,
...
Order
OrderSamples::PeggedToBenchmark(std::string action, double quantity, double startingPrice, bool peggedChangeAmountDecrease, double peggedChangeAmount,
                                double referenceChangeAmount, int referenceConId, std::string referenceExchange, double stockReferencePrice,
...
Order OrderSamples::AttachAdjustableToStopLimit(Order parent, double attachedOrderStopPrice, double triggerPrice, double adjustStopPrice,
...
Order OrderSamples::AttachAdjustableToTrail(Order parent, double attachedOrderStopPrice, double triggerPrice, double adjustStopPrice,
...
OrderCondition *OrderSamples::Percent_Change_Condition(double pctChange, int conId, std::string exchange, bool isMore, bool isConjunction)
{
        ...
        PercentChangeCondition *pctChangeCondition = dynamic_cast<PercentChangeCondition *>(OrderCondition::create(
                OrderCondition::OrderConditionType::PercentChange));
